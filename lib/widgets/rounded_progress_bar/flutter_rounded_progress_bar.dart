...
class RoundedProgressBarState extends State<RoundedProgressBar> {
  ...
  void initState() {
    ...
    if (widget.theme != null) {
      style = RoundedProgressBarStyle(backgroundProgress: backgroundProgressDefault, colorProgress: colorProgressMidnight, colorProgressDark: colorProgressMidnightDark, colorBorder: colorBorderDefault);
    }
