            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Text(bankAccountProof.toUpperCase(), style: TextStyle(fontSize: 20, color: AppColors.colorPrimary, fontWeight: FontWeight.bold),),
                  ...
                  Padding(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                          ...
                          suffixIcon: Icon(Icons.account_balance, size: 20, color: AppColors.colorPrimary,),
                          floatingLabelBehavior: FloatingLabelBehavior.always,
                          labelText:bankAccountNumber,
                  ...
                  Padding(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                          contentPadding: EdgeInsets.all(0),
                          suffixIcon: Icon(Icons.account_circle, size: 20,),
                  ...
                  Padding(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                          contentPadding: EdgeInsets.all(0),
                          suffixIcon: Icon(Icons.account_balance, size: 20,),
                          floatingLabelBehavior: FloatingLabelBehavior.auto,
                          labelText:ifscCode
                      ),
                    ),
                  ...
                  Padding(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                          contentPadding: EdgeInsets.all(0),
                          suffixIcon: Icon(Icons.home, size: 20,),
                          floatingLabelBehavior: FloatingLabelBehavior.auto,
                          labelText:address
                      ),
                    ),
