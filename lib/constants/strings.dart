...
const give_your_contest_a_name = "Give your contest a name";
const total_wining_amount = "Total wining amount(Rs)";
const String min0 = "0 - 10,000";
const contest_size = "Contest size";
const min2 = "min 2";
